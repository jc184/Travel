                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-textarea label="What to expect"
                                                v-model="bodyRequest.whatToExpect"
                                                required></v-textarea>
                                </v-col>
                                <v-col cols="12">
                                    <v-text-field label="Map Location"
                                                  v-model="bodyRequest.mapLocation"
                                                  required></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="4">
                                    <v-text-field label="Price in USD"
                                                  v-model="bodyRequest.price"
                                                  required></v-text-field>
                                </v-col>
                                <v-col cols="12" sm="4">
                                    <v-autocomplete :items="durations"
                                                    v-model="bodyRequest.duration"
                                                    label="Duration in hours"></v-autocomplete>
                                </v-col>
                                <v-col cols="12" sm="4">
                                    <v-switch label="Instant confirmation"
                                              v-model="bodyRequest.instantConfirmation"></v-switch>
                                </v-col>
                            </v-row>
                        </v-container>
